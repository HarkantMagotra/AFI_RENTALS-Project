...
#         # Correctly calculate total_records
...
#         if file_type == 'leads':
#             # For leads, check the 'total_leads' field
...
#             # For accounts, check the 'total_accounts' field
...
#             # For contacts, check the 'total_contacts' field
